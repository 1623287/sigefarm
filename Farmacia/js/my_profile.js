...
function updateAdminDetails() {
  ...
  if(!validateName(pharmacy_name.value, 'pharmacy_name_error'))
    ...
    var password = prompt("Debe ingresar la contraseña para actualizar la información");
    if(validatePassword(password)) {
      ...
      document.getElementById('admin_acknowledgement').innerHTML = "<span class='text-danger'>Clave incorrecta</span>";
    return false;
  }
}
...
function changePassword() {
  ...
  if(!checkAdminPassword(old_password.value, 'old_password_error'))
    ...
    document.getElementById('confirm_password_error').innerHTML = "La contraseña no coincide";
