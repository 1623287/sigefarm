...
function addInvoice() {
  ...
  if(!notNull(customers_name.value, "customer_name_error"))
    ...
    document.getElementById("customer_name_error").innerHTML = "El cliente no existe!";
    customers_name.focus();
  }
  else if(isInvoiceExist(invoice_number.value) == "true")
    document.getElementById("invoice_acknowledgement").innerHTML = "El comprobante ya está guardado!";
    ...
    for(var i = 1; i < row_count; i++) {
      ...
      if(!notNull(medicine_name.value, medicine_name_error.getAttribute('id')))
        ...
        medicine_name_error.innerHTML = "La medicina no existe";
        medicine_name.focus();
      }
        ...
        quantity_error.innerHTML = "Aumenta la cantidad o elimina la fila";
        quantity.focus();
      }
