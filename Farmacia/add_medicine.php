...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Registrar Nueva Medicina</title>
    ...
    <div id="add_new_supplier_model">
      <div class="modal-dialog">
      	<div class="modal-content">
            ...
            <div class="font-weight-bold">Registrar Nuevo Proveedor</div>
    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('shopping-bag', 'Registrar Medicina', 'Registrar Nueva Medicina');
        ?>
