    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('home', 'Tablero', 'Inicio');
        ?>
        ...
        <div class="row">
          <div class="row col col-xs-8 col-sm-8 col-md-8 col-lg-8">
            ...
            <?php
              ...
              createSection1('manage_customer.php', 'Total de Clientes', 'customers');
              createSection1('manage_supplier.php', 'Total de Proveedores', 'suppliers');
              createSection1('manage_medicine.php', 'Total de Medicinas', 'medicines');
              createSection1('manage_medicine_stock.php?out_of_stock', 'Fuera de Stock', 'medicines_stock');
              createSection1('manage_medicine_stock.php?expired', 'Expirados', 'medicines_stock');
              createSection1('manage_invoice.php', 'Total de Facturas', 'invoices');
            ?>
          ...
          <div class="col col-xs-4 col-sm-4 col-md-4 col-lg-4" style="padding: 7px 0; margin-left: 15px;">
            <div class="todays-report">
              <div class="h5">Informe del Día</div>
        ...
        <div class="row">
          ...
          <?php
            ...
            createSection2('address-card', 'new_invoice.php', 'Crear Nueva Factura');
            createSection2('handshake', 'add_customer.php', 'Registrar Nuevo Cliente');
            createSection2('shopping-bag', 'add_medicine.php', 'Registrar Nueva Medicina');
            createSection2('group', 'add_supplier.php', 'Registrar Nuevo Proveedor');
            createSection2('bar-chart', 'add_purchase.php', 'Registrar Nueva Compra');
            createSection2('book', 'sales_report.php', 'Reporte de Ventas');
            createSection2('book', 'purchase_report.php', 'Reporte de Compras');
          ?>
