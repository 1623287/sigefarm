    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('key', 'Cambiar Contraseña', 'Crear Nueva Contraseña');
          ...
          <div class="row col col-md-6">
            ...
            <div class="row col col-md-12">
              <div class="col col-md-12 form-group">
                <label class="font-weight-bold" for="old_password">Contraseña Actual :</label>
                <input id="old_password" type="text" class="form-control" placeholder="contraseña actual" onblur="checkAdminPassword(this.value, 'old_password_error');">
            ...
            <div class="row col col-md-12">
              <div class="col col-md-12 form-group">
                ...
                <input id="password" type="text" class="form-control" placeholder="contraseña" style="max-height: 100px;">
            ...
            <div class="row col col-md-12">
              <div class="col col-md-12 form-group">
                <label class="font-weight-bold" for="confirm_password">Confirmar Nueva Contraseña :</label>
            ...
            <div class="row col col-md-12 m-auto" id="change">
              ...
              <div id="change_button" class="col col-md-4 form-group float-right">
                <button class="btn btn-warning form-control font-weight-bold" onclick="changePassword();">Cambiar Contraseña</button>
              </div>
              <div id="password_button" class="col col-md-4 form-group float-right">
                <a href="my_profile.php" class="btn btn-primary form-control font-weight-bold">Perfil</a>
              </div>
            </div>
