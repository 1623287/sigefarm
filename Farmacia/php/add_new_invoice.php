<?php
  ...
  function updateStock($name, $batch_id, $quantity) {
    ...
    if($con) {
      ...
      $result = mysqli_query($con, $query);
      echo ($result) ? "Stock actualizado" : "Error al actualizar stock";
    }
  }
  ...
  function addSale() {
    ...
    if($con) {
      ...
      $result = mysqli_query($con, $query);
      echo ($result) ? "Venta registrada" : "Error al registrar venta...";
    }
  }
  ...
  function addNewInvoice() {
    ...
    if($con) {
      ...
      $result = mysqli_query($con, $query);
      echo ($result) ? "Comprobante guardado" : "Error al agregar comprobante...";
    }
  }
?>
