<?php
  ...
  function printInvoice($invoice_number) {
    ...
    <div class="row">
      ...
      <div class="col-md-10 h3" style="color: #ff5252;">Factura del Cliente<span class="float-right">Nº Factura : <?php echo $invoice_number; ?></span></div>
    </div>
    <div class="row font-weight-bold">
      <div class="col-md-1"></div>
      <div class="col-md-10"><span class="h4 float-right">Fecha de Factura : <?php echo $invoice_date; ?></span></div>
    </div>
    ...
    <div class="row">
      <div class="col-md-1"></div>
      <div class="col-md-4">
        <span class="h4">Cliente : </span><br><br>
        <span class="font-weight-bold">Nombre : </span><?php echo $customer_name; ?><br>
        <span class="font-weight-bold">Dirección : </span><?php echo $address; ?><br>
        <span class="font-weight-bold">Celular : </span><?php echo $contact_number; ?><br>
        <span class="font-weight-bold">Nombre del Doctor : </span><?php echo $doctor_name; ?><br>
        <span class="font-weight-bold">Dirección del Doctor : </span><?php echo $doctor_address; ?><br>
      </div>
      ...
      <div class="col-md-4">
        <span class="h4">Farmacia : </span><br><br>
        ...
        <span class="font-weight-bold">Celular : <?php echo $p_contact_number; ?></span>
      </div>
      <div class="col-md-1"></div>
    </div>
    <div class="row text-center">
      ...
      <div class="col-md-10 table-responsive">
        <table class="table table-bordered table-striped table-hover" id="purchase_report_div">
          ...
          <tfoot class="font-weight-bold">
            ...
            <tr style="text-align: right; font-size: 18px;">
              <td colspan="6">&nbsp;Descuento Total</td>
              <td><?php echo $total_discount; ?></td>
            </tr>
            <tr style="text-align: right; font-size: 22px;">
              <td colspan="6" style="color: green;">&nbsp;Monto Neto</td>
