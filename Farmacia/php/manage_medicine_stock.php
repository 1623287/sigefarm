...
function showEditOptionsRow($seq_no, $row) {
  ...
  <tr>
    ...
    <td><?php echo $row['GENERIC_NAME']; ?></td>
    <td>
      <input type="text" class="form-control" value="<?php echo $row['BATCH_ID']; ?>" placeholder="ID de Lote" id="batch_id" onblur="notNull(this.value, 'batch_id_error');">
      <code class="text-danger small font-weight-bold float-right" id="batch_id_error" style="display: none;"></code>
    </td>
    <td>
      <input type="text" class="form-control" value="<?php echo $row['EXPIRY_DATE']; ?>" placeholder="Fecha" id="expiry_date" onblur="checkExpiry(this.value, 'expiry_date_error');">
      <code class="text-danger small font-weight-bold float-right" id="expiry_date_error" style="display: none;"></code>
    </td>
    <td><?php echo $row['SUPPLIER_NAME']; ?></td>
    <td>
      <input type="number" class="form-control" value="<?php echo $row['QUANTITY']; ?>" placeholder="Cant." id="quantity" onkeyup="checkQuantity(this.value, 'quantity_error');">
    ...
    <td>
      <input type="number" class="form-control" value="<?php echo $row['RATE']; ?>" placeholder="Precio" id="rate" onkeyup="checkValue(this.value, 'rate_error');">
