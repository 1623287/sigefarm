    ...
    <section class="row content-header">
      ...
      <div class="col-md-1 user_options">
        ...
        <ul id="options" class="options list-unstyled" style="display: none;">
          <li>
            <a href="my_profile.php"><i class="fa fa-user"></i><span>Mi Cuenta</span></a>
          </li>
          <li>
            <a href="change_password.php"><i class="fa fa-edit"></i><span>Cambiar Contraseña</span></a>
          </li>
          <li>
            <a href="logout.php"><i class="fa fa-key"></i><span>Cerrar Sesión</span></a>
          </li>
        </ul>
      </div>
    </section>
