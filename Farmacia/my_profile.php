    ...
    <div class="container-fluid">
      <div class="container">
        <?php
          ...
          createHeader('user', 'Perfil', 'Administrar Detalles del Administrador');
          ...
          <div class="row col col-md-6">
            ...
            <div class="row col col-md-12">
              <div class="col col-md-12 form-group">
                <label class="font-weight-bold" for="pharmacy_name">Nombre de Farmacia :</label>
                <input id="pharmacy_name" type="text" class="form-control" value="<?php echo $pharmacy_name; ?>" placeholder="nombre de farmacia" onkeyup="validateName(this.value, 'pharmacy_name_error');" disabled>
            ...
            <div class="row col col-md-12">
              <div class="col col-md-12 form-group">
                ...
                <textarea id="address" class="form-control" placeholder="dirección" onkeyup="validateAddress(this.value, 'address_error');" style="max-height: 100px;" disabled><?php echo $address; ?></textarea>
            ...
            <div class="row col col-md-12">
              <div class="col col-md-12 form-group">
                <label class="font-weight-bold" for="contact_number">Número de Contacto :</label>
                <input id="contact_number" type="number" class="form-control" value="<?php echo $contact_number; ?>" placeholder="número de contacto" onkeyup="validateContactNumber(this.value, 'contact_number_error');" disabled>
            ...
            <div class="row col col-md-12">
              <div class="col col-md-12 form-group">
                ...
                <input id="username" type="text" class="form-control" value="<?php echo $username; ?>" placeholder="nombre de usuario" onkeyup="notNull(this.value, 'username_error');" disabled>
            ...
            <div class="row col col-md-12 m-auto" id="edit">
              ...
              <div id="edit_button" class="col col-md-4 form-group float-right">
                <button class="btn btn-primary form-control font-weight-bold" onclick="edit();">EDITAR</button>
              </div>
              <div id="password_button" class="col col-md-4 form-group float-right">
                <a href="change_password.php" class="btn btn-warning form-control font-weight-bold">Cambiar Clave</a>
              </div>
            </div>
            ...
            <div class="row col col-md-12 m-auto" id="update_cancel" style="display: none;">
              ...
              <div id="cancel_button" class="col col-md-4 form-group float-right">
                <button class="btn btn-danger form-control font-weight-bold" onclick="edit(true);">CANCELAR</button>
              </div>
              <div id="update_button" class="col col-md-4 form-group float-right">
                <button class="btn btn-success form-control font-weight-bold" onclick="updateAdminDetails();">ACTUALIZAR</button>
              </div>
            </div>
